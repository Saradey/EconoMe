...
public class MainActivityHolder(container: FeatureContainer) :
    FeatureHolder<evgenii.goncharov.econome.main_activity.di.contracts.MainActivityApi>(container) {

    override fun buildComponent(): evgenii.goncharov.econome.main_activity.di.contracts.MainActivityApi {

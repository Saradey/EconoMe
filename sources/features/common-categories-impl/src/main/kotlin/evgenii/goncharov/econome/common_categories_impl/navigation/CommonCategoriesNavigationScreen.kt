...
import evgenii.goncharov.econome.common_categories_impl.fragments.AddCategoriesDialogFragment
...
internal object CommonCategoriesNavigationScreen {
    ...
    fun startAddCategories() = FragmentScreen {
        AddCategoriesDialogFragment.newInstance()
    }
}
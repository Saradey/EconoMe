...
internal interface AnalysisGoodsCostBindModule {

    @[Binds FeatureScope]
    @[IntoMap ViewModelKey(AnalysisGoodsCostViewModel::class)]
    fun bindAnalysisGoodsCostViewModel(viewModel: AnalysisGoodsCostViewModel): ViewModel
}
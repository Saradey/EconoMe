...
import evgenii.goncharov.econome.product_cost_analysis_impl.view.models.AppShopViewModel

@Module(includes = [MultiViewModelModule::class])
internal interface AppShopBindModule {

    @[Binds FeatureScope]
    @[IntoMap ViewModelKey(AppShopViewModel::class)]
    fun bindAppShopViewModel(viewModel: AppShopViewModel): ViewModel
}